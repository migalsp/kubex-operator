...
```bash
helm upgrade --install kubex-operator oci://ghcr.io/migalsp/kubex/charts/kubex-operator \
  --version v1.0.0 \
  --namespace kubex
```
...
```bash
helm show values oci://ghcr.io/migalsp/kubex/charts/kubex-operator --version v1.0.0
```
...
image:
  repository: ghcr.io/migalsp/kubex/kubex-operator
...
```bash
helm upgrade kubex-operator oci://ghcr.io/migalsp/kubex/charts/kubex-operator \
  --version v1.1.0 \
  --namespace kubex
```
