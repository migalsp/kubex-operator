...
import (
	...
	"github.com/migalsp/kubex-operator/internal/api"
...
func main() {
	...
	// Setup custom certificates for the metrics server if provided, otherwise
	// controller-runtime will generate self-signed ones.
	...
	mgr, err := ctrl.NewManager(config, ctrl.Options{
		...
		LeaderElectionID:       "fdcd422b.kubex.io",
	})
	if err != nil {
